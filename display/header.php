...
for(let n of counters) {
  const updateCount = () => {
    const target = + n.getAttribute('data-target');//final value to display
    let count = + n.innerText; //actual live count
    let speed = 5000; // change animation speed here (lower number means high speed)
