                    ...
                    <div class="header-content-follow">
                      <h3 class="footer-title">Follow Us</h3>
                        ...
                        <a class="fa-brands fa-facebook"
                          href="" target="_blank" data-spm-click="gostr=/gvspub.footer.sns;locaid=d_fbk"
                        ></a>
                      
                        
                        <a class="fa-brands fa-twitter"
                          href="" target="_blank" data-spm-click="gostr=/gvspub.footer.sns;locaid=d_twr"
                        ></a>
                      
                        
                        <a class="fa-brands fa-instagram"
                          href="" target="_blank" data-spm-click="gostr=/gvspub.footer.sns;locaid=d_ins"
                        ></a>
                      
                        
                        <a class="fa-brands fa-youtube"
                          href="" target="_blank" data-spm-click="gostr=/gvspub.footer.sns;locaid=d_ytb"
                        ></a>
...
$card_offerse = "SELECT bank FROM card_offers";
