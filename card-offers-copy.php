    ...
    <div class="filter_main_div1">
      <div class="filter_main_div1_type">
        ...
        <span class="custom-dropdown big">
          <select class=""  name="type" id="type">
    		  ...
    		  <option value="Food %26 Drink">Food & Drink</option>
    		  <option value="Entertainment">Entertainment</option>
    		  <option value="Supermarkets">Supermarkets</option>
    		  <option value="Fashion %26 Other">Fashion & Other</option>
    		  <option value="Hotels %26 Travels">Hotels & Travels</option>
    		  <option value="Health %26 Insurance">Health & Insurance</option>
        </select>
      </span>
      </div>
      <div class="filter_main_div1_calender">
        <div class="filter_main_div1_calender_1">
          ...
          <span class="filter_main_div1_calender_1_span"><input type="text" name="daterange" value="" /></span>
    ...
    while ($carousel_1=$card_offers_prep->fetch()) {
       ...
       if($carousel_1){
        ...
        print('<a class="card-official-stores-box hp-mod-card-hover align-left bank-offers" href="'.$carousel_1['link'].'"  title="'.$carousel_1['bank'].'" target="blank">
                ...
                <div class="card-official-stores-h1">'.$carousel_1['tittle'].'</div>
...
<script src="js/card-offers-copy.js"></script>
