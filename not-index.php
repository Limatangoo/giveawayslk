...
<?php include 'display/not-header.php' ?>
...
/*bank offer details*/
$card_offers = "SELECT bank,tittle,card_type,proccessor_type,percentage,cover_photo,link FROM card_offers WHERE sub_category=:sub_category ORDER BY percentage DESC";
$card_offers_prep=$conn->prepare($card_offers);
$card_offers_prep->bindValue(':sub_category',"Hotels & Travels");
